...
namespace WindowsFormsApp1
{
    public partial class Billings : Form
    {
        ...
        {
            e.Graphics.DrawString("Quản lý tân dược",new Font("Century Gothic",12,FontStyle.Bold),Brushes.Red, new Point(50));
            e.Graphics.DrawString("Mã SảnPhẩm Giá Sốlượng TổngTiền", new Font("Century Gothic", 12, FontStyle.Bold), Brushes.Red, new Point(5,20));
            ...
            e.Graphics.DrawString("________Quản lý TÂN DƯỢC______", new Font("Century Gothic", 12, FontStyle.Bold), Brushes.Crimson, new Point(0, pos + 85));
            BillDGV.Rows.Clear();
            BillDGV.Refresh();
            pos = 100;
            GrdTotal = 0;
