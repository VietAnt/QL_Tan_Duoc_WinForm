...
namespace WindowsFormsApp1
{
    public partial class Login : Form
    {
        ...
        SqlConnection conn = new SqlConnection(@"Data Source=NIKE;Initial Catalog=C:\USERS\TRANV\ONEDRIVE\DESKTOP\QL_TÂN_DƯỢC\DATABASE\PETSHOPDB.MDF;Integrated Security=True");
